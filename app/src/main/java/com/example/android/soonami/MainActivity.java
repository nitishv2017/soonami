...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2020-01-01&endtime=2020-12-01&minmagnitude=6";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                else Log.e(LOG_TAG, "makeHttpRequest: response code ="+ urlConnection.getResponseCode() );

            } catch (IOException e) {
                Log.e(LOG_TAG, "Problem getting response ", e);
            } finally {
